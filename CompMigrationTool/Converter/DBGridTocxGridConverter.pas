...
type
  TConverterDBGridToCXGrid = class(TConverter)
  private
...
destructor TConverterDBGridToCXGrid.Destroy;
begin
...
function TConverterDBGridToCXGrid.GetDescription: string;
begin
  Result := 'DBGrid to cxGrid 변환';
end;

function TConverterDBGridToCXGrid.GetComponentClassName: string;
begin
  Result := 'TDBGrid';
end;

function TConverterDBGridToCXGrid.GetConvertCompClassName: string;
begin
  Result := 'TcxGrid';
end;

function TConverterDBGridToCXGrid.GetMainUsesUnit: string;
begin
  Result := 'cxGrid';
end;

function TConverterDBGridToCXGrid.GetAddedUses: TArray<string>;
begin
  Result := [
      'cxGraphics', 'cxControls', 'cxLookAndFeels', 'cxLookAndFeelPainters', 'dxSkinsCore',
      'dxSkinsDefaultPainters', 'cxStyles', 'cxCustomData', 'cxFilter', 'cxData',
      'cxDataStorage', 'cxEdit', 'cxNavigator', 'dxDateRanges', 'cxDBData', 'cxLabel',
      'cxGridCustomTableView', 'cxGridTableView', 'cxGridDBTableView', 'cxGridLevel',
      'cxClasses', 'cxGridCustomView', 'cxGrid'
    ];
end;

function TConverterDBGridToCXGrid.GetRemoveUses: TArray<string>;
begin
  Result := ['Grids', 'DBGrids'];
end;

function TConverterDBGridToCXGrid.GetConvertCompList(AMainCompName: string): string;
var
...
function TConverterDBGridToCXGrid.GetConvertedCompText(ACompText: TStrings): string;
var
  Idx: Integer;
...
function TConverterDBGridToCXGrid.GetCompEventInfos(AFormClass: string): TArray<TCompEventInfo>;
...
function TConverterDBGridToCXGrid.IsWantWriteEvnetCodeToPas: Boolean;
begin
  Result := True;
end;

initialization
  TConvertManager.Instance.Regist(TConverterDBGridToCXGrid);
